      ...
      <div className="flex flex-wrap">
        <div className=" sm:w-[35%] w-full py-6">
          <div className="p-4">
            ...
            <p className="text-neutral-500 pt-4 leading-6 -tracking-tighter font-sans text-sm">
              ...
              laudantium tempore quaerat placeat, qui totam.
            </p>
        ...
        <div className="sm:w-[25%] w-full py-6 pl-6 ">
          ...
          <div className="flex gap-3 ">
            <div className="rounded-[100%]  h-10 w-10 border-dashed border-2 border-green-500 flex items-center justify-center hover:bg-green-500 ">
            <FaFacebookF  />
            </div>
            <div className="rounded-[100%]  h-10 w-10 border-dashed border-2 border-green-500 flex items-center justify-center hover:bg-green-500">
            <FiTwitter  />
